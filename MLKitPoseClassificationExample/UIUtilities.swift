...
public class UIUtilities {
	...
	public static func createPoseOverlayView(
		...
		let farZColor = UIColor.systemRed
		...
		for (startLandmarkType, endLandmarkTypesArray) in UIUtilities.poseConnections() {
			...
			for endLandmarkType in endLandmarkTypesArray {
				...
				// don't dra
				if startLandmark.inFrameLikelihood < confidenceThreshold || endLandmark.inFrameLikelihood < confidenceThreshold { continue }
		...
		for landmark in pose.landmarks {
			if landmark.inFrameLikelihood < confidenceThreshold { continue }
	...
	private static func interpolatedColor(
		...
		var fromR: CGFloat = 245
		var fromG: CGFloat = 83
		var fromB: CGFloat = 83
		var fromA: CGFloat = 1
